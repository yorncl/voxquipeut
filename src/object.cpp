...
Object build_cube(glm::vec3 pos, glm::vec3 scale) {
    ...
    cube.pos = pos;
    cube.scale = scale;
    // assert(sizeof(cube_vertices) == sizeof(cube_colors) ==
           // sizeof(cube_normals));
    ...
    cube.m.normals.assign(
        cube_normals, cube_normals + (sizeof(cube_normals) / sizeof(float)));
    cube.m.dirty = true;
...
// TODO the shading of this cube shouldn't be defined by the normal data
Object build_unicolor_cube(glm::vec3 pos, glm::vec3 scale, glm::vec3 color) {
    ...
    cube.m.normals.assign(cube.m.normals.size(), 1.0);
